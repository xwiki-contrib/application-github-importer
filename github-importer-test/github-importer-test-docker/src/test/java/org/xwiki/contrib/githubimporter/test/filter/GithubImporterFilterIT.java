 ...
 */
package org.xwiki.contrib.githubimporter.test.filter;
...
public class GithubImporterFilterIT
{
        ...
        throws IOException, InterruptedException
    {
        ...
        ViewPage vp = applicationIndexHomePage.clickApplication("Filter Streams Converter");

        // Set input
        Select inputType = new Select(driver.findElement(By.id("filter_input_type")));
        inputType.selectByValue("githubimporter+wiki");

        WebElement inputElement = driver.findElement(By.id("filter_input_properties_descriptor_parent"));
        inputElement.sendKeys("GitHubImporterFilterTest");
        inputElement = driver.findElement(By.id("filter_input_properties_descriptor_source"));
        inputElement.sendKeys("url:"+"https://github.com/Haxsen/TestRepo.wiki.git");
        ...
        // Start conversion
        WebElement submit = driver.findElement(By.name("convert"));
        submit.click();
        ...
        // Check the output
        ViewPage viewPage = setup.gotoPage("GitHubImporterFilterTest","Home");
